...
#if defined(TARGET_IO_PORTJ)
# define DEFIO_PORT_J_USED_MASK TARGET_IO_PORTJ
# define DEFIO_PORT_J_USED_COUNT BITCOUNT(DEFIO_PORT_J_USED_MASK)
#else
# define DEFIO_PORT_J_USED_MASK 0
# define DEFIO_PORT_J_USED_COUNT 0
#endif
#define DEFIO_PORT_J_OFFSET (DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)

#if defined(TARGET_IO_PORTK)
# define DEFIO_PORT_K_USED_MASK TARGET_IO_PORTK
# define DEFIO_PORT_K_USED_COUNT BITCOUNT(DEFIO_PORT_K_USED_MASK)
#else
# define DEFIO_PORT_K_USED_MASK 0
# define DEFIO_PORT_K_USED_COUNT 0
#endif
#define DEFIO_PORT_K_OFFSET (DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
...
#define DEFIO_GPIOID__J 9
#define DEFIO_GPIOID__K 10
...
#else
# define DEFIO_TAG__PH7 defio_error_PH7_is_not_supported_on_TARGET_ozzy
# define DEFIO_TAG_E__PH7 DEFIO_TAG_E__NONE
# define DEFIO_REC__PH7 defio_error_PH7_is_not_supported_on_TARGET_ozzy
#endif
...
#if DEFIO_PORT_J_USED_MASK & BIT(0)
# define DEFIO_TAG__PJ0 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 0)
# define DEFIO_TAG_E__PJ0 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 0)
# define DEFIO_REC__PJ0 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(0) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ0 defio_error_PJ0_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ0 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ0 defio_error_PK0_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(1)
# define DEFIO_TAG__PJ1 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 1)
# define DEFIO_TAG_E__PJ1 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 1)
# define DEFIO_REC__PJ1 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(1) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ1 defio_error_PJ1_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ1 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ1 defio_error_PJ1_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(2)
# define DEFIO_TAG__PJ2 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 2)
# define DEFIO_TAG_E__PJ2 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 2)
# define DEFIO_REC__PJ2 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(2) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ2 defio_error_PJ2_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ2 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ2 defio_error_PJ2_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(3)
# define DEFIO_TAG__PJ3 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 3)
# define DEFIO_TAG_E__PJ3 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 3)
# define DEFIO_REC__PJ3 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(3) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ3 defio_error_PJ3_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ3 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ3 defio_error_PJ3_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(4)
# define DEFIO_TAG__PJ4 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 4)
# define DEFIO_TAG_E__PJ4 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 4)
# define DEFIO_REC__PJ4 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(4) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ4 defio_error_PJ4_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ4 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ4 defio_error_PJ4_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(5)
# define DEFIO_TAG__PJ5 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 5)
# define DEFIO_TAG_E__PJ5 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 5)
# define DEFIO_REC__PJ5 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(5) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ5 defio_error_PJ5_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ5 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ5 defio_error_PJ5_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(6)
# define DEFIO_TAG__PJ6 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 6)
# define DEFIO_TAG_E__PJ6 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 6)
# define DEFIO_REC__PJ6 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(6) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ6 defio_error_PJ6_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ6 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ6 defio_error_PJ6_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(7)
# define DEFIO_TAG__PJ7 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 7)
# define DEFIO_TAG_E__PJ7 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 7)
# define DEFIO_REC__PJ7 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(7) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ7 defio_error_PJ7_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ7 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ7 defio_error_PJ7_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(8)
# define DEFIO_TAG__PJ8 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 8)
# define DEFIO_TAG_E__PJ8 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 8)
# define DEFIO_REC__PJ8 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(8) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ8 defio_error_PJ8_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ8 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ8 defio_error_PJ8_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(9)
# define DEFIO_TAG__PJ9 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 9)
# define DEFIO_TAG_E__PJ9 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 9)
# define DEFIO_REC__PJ9 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(9) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ9 defio_error_PJ9_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ9 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ9 defio_error_PJ9_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(10)
# define DEFIO_TAG__PJ10 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 10)
# define DEFIO_TAG_E__PJ10 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 10)
# define DEFIO_REC__PJ10 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(10) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ10 defio_error_PJ10_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ10 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ10 defio_error_PJ10_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(11)
# define DEFIO_TAG__PJ11 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 11)
# define DEFIO_TAG_E__PJ11 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 11)
# define DEFIO_REC__PJ11 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(11) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT)+DEFIO_PORT_I_USED_COUNT
#else
# define DEFIO_TAG__PJ11 defio_error_PJ11_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ11 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ11 defio_error_PJ11_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(12)
# define DEFIO_TAG__PJ12 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 12)
# define DEFIO_TAG_E__PJ12 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 12)
# define DEFIO_REC__PJ12 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(12) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ12 defio_error_PJ12_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ12 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ12 defio_error_PJ12_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(13)
# define DEFIO_TAG__PJ13 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 13)
# define DEFIO_TAG_E__PJ13 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 13)
# define DEFIO_REC__PJ13 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(13) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT
#else
# define DEFIO_TAG__PJ13 defio_error_PJ13_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ13 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ13 defio_error_PJ13_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(14)
# define DEFIO_TAG__PJ14 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 14)
# define DEFIO_TAG_E__PJ14 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 14)
# define DEFIO_REC__PJ14 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(14) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ14 defio_error_PJ14_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ14 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ14 defio_error_PJ14_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_J_USED_MASK & BIT(15)
# define DEFIO_TAG__PJ15 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 15)
# define DEFIO_TAG_E__PJ15 DEFIO_TAG_MAKE(DEFIO_GPIOID__J, 15)
# define DEFIO_REC__PJ15 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_J_USED_MASK & (BIT(15) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT)
#else
# define DEFIO_TAG__PJ15 defio_error_PJ15_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PJ15 DEFIO_TAG_E__NONE
# define DEFIO_REC__PJ15 defio_error_PJ15_is_not_supported_on_TARGET
#endif


#if DEFIO_PORT_K_USED_MASK & BIT(0)
# define DEFIO_TAG__PK0 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 0)
# define DEFIO_TAG_E__PK0 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 0)
# define DEFIO_REC__PK0 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(0) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK0 defio_error_PK0_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK0 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK0 defio_error_PK0_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(1)
# define DEFIO_TAG__PK1 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 1)
# define DEFIO_TAG_E__PK1 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 1)
# define DEFIO_REC__PK1 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(1) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK1 defio_error_PK1_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK1 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK1 defio_error_PK1_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(2)
# define DEFIO_TAG__PK2 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 2)
# define DEFIO_TAG_E__PK2 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 2)
# define DEFIO_REC__PK2 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(2) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK2 defio_error_PK2_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK2 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK2 defio_error_PK2_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(3)
# define DEFIO_TAG__PK3 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 3)
# define DEFIO_TAG_E__PK3 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 3)
# define DEFIO_REC__PK3 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(3) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK3 defio_error_PK3_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK3 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK3 defio_error_PK3_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(4)
# define DEFIO_TAG__PK4 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 4)
# define DEFIO_TAG_E__PK4 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 4)
# define DEFIO_REC__PK4 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(4) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK4 defio_error_PK4_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK4 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK4 defio_error_PK4_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(5)
# define DEFIO_TAG__PK5 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 5)
# define DEFIO_TAG_E__PK5 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 5)
# define DEFIO_REC__PK5 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(5) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK5 defio_error_PK5_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK5 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK5 defio_error_PK5_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(6)
# define DEFIO_TAG__PK6 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 6)
# define DEFIO_TAG_E__PK6 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 6)
# define DEFIO_REC__PK6 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(6) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK6 defio_error_PK6_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK6 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK6 defio_error_PK6_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(7)
# define DEFIO_TAG__PK7 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 7)
# define DEFIO_TAG_E__PK7 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 7)
# define DEFIO_REC__PK7 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(7) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK7 defio_error_PK7_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK7 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK7 defio_error_PK7_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(8)
# define DEFIO_TAG__PK8 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 8)
# define DEFIO_TAG_E__PK8 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 8)
# define DEFIO_REC__PK8 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(8) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK8 defio_error_PK8_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK8 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK8 defio_error_PK8_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(9)
# define DEFIO_TAG__PK9 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 9)
# define DEFIO_TAG_E__PK9 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 9)
# define DEFIO_REC__PK9 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(9) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK9 defio_error_PK9_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK9 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK9 defio_error_PK9_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(10)
# define DEFIO_TAG__PK10 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 10)
# define DEFIO_TAG_E__PK10 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 10)
# define DEFIO_REC__PK10 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(10) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK10 defio_error_PK10_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK10 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK10 defio_error_PK10_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(11)
# define DEFIO_TAG__PK11 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 11)
# define DEFIO_TAG_E__PK11 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 11)
# define DEFIO_REC__PK11 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(11) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT)+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT
#else
# define DEFIO_TAG__PK11 defio_error_PK11_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK11 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK11 defio_error_PK11_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(12)
# define DEFIO_TAG__PK12 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 12)
# define DEFIO_TAG_E__PK12 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 12)
# define DEFIO_REC__PK12 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(12) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK12 defio_error_PK12_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK12 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK12 defio_error_PK12_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(13)
# define DEFIO_TAG__PK13 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 13)
# define DEFIO_TAG_E__PK13 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 13)
# define DEFIO_REC__PK13 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(13) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT
#else
# define DEFIO_TAG__PK13 defio_error_PK13_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK13 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK13 defio_error_PK13_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(14)
# define DEFIO_TAG__PK14 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 14)
# define DEFIO_TAG_E__PK14 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 14)
# define DEFIO_REC__PK14 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(14) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK14 defio_error_PK14_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK14 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK14 defio_error_PK14_is_not_supported_on_TARGET
#endif
#if DEFIO_PORT_K_USED_MASK & BIT(15)
# define DEFIO_TAG__PK15 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 15)
# define DEFIO_TAG_E__PK15 DEFIO_TAG_MAKE(DEFIO_GPIOID__K, 15)
# define DEFIO_REC__PK15 DEFIO_REC_INDEXED(BITCOUNT(DEFIO_PORT_K_USED_MASK & (BIT(15) - 1)) + DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT)
#else
# define DEFIO_TAG__PK15 defio_error_PK15_is_not_supported_on_TARGET
# define DEFIO_TAG_E__PK15 DEFIO_TAG_E__NONE
# define DEFIO_REC__PK15 defio_error_PK15_is_not_supported_on_TARGET
#endif


// DEFIO_IO_USED_COUNT is number of io pins supported on target
#define DEFIO_IO_USED_COUNT (DEFIO_PORT_A_USED_COUNT+DEFIO_PORT_B_USED_COUNT+DEFIO_PORT_C_USED_COUNT+DEFIO_PORT_D_USED_COUNT+DEFIO_PORT_E_USED_COUNT+DEFIO_PORT_F_USED_COUNT+DEFIO_PORT_G_USED_COUNT+DEFIO_PORT_H_USED_COUNT+DEFIO_PORT_I_USED_COUNT+DEFIO_PORT_J_USED_COUNT+DEFIO_PORT_K_USED_COUNT)
...
#if !defined DEFIO_PORT_USED_LIST && DEFIO_PORT_K_USED_COUNT > 0
# define DEFIO_PORT_USED_COUNT 11
# define DEFIO_PORT_USED_LIST DEFIO_PORT_A_USED_MASK,DEFIO_PORT_B_USED_MASK,DEFIO_PORT_C_USED_MASK,DEFIO_PORT_D_USED_MASK,DEFIO_PORT_E_USED_MASK,DEFIO_PORT_F_USED_MASK,DEFIO_PORT_G_USED_MASK,DEFIO_PORT_H_USED_MASK,DEFIO_PORT_I_USED_MASK,DEFIO_PORT_J_USED_MASK,DEFIO_PORT_K_USED_MASK
# define DEFIO_PORT_OFFSET_LIST DEFIO_PORT_A_OFFSET,DEFIO_PORT_B_OFFSET,DEFIO_PORT_C_OFFSET,DEFIO_PORT_D_OFFSET,DEFIO_PORT_E_OFFSET,DEFIO_PORT_F_OFFSET,DEFIO_PORT_G_OFFSET,DEFIO_PORT_H_OFFSET,DEFIO_PORT_I_OFFSET,DEFIO_PORT_J_OFFSET,DEFIO_PORT_K_OFFSET
#endif

#if !defined DEFIO_PORT_USED_LIST && DEFIO_PORT_J_USED_COUNT > 0
# define DEFIO_PORT_USED_COUNT 10
# define DEFIO_PORT_USED_LIST DEFIO_PORT_A_USED_MASK,DEFIO_PORT_B_USED_MASK,DEFIO_PORT_C_USED_MASK,DEFIO_PORT_D_USED_MASK,DEFIO_PORT_E_USED_MASK,DEFIO_PORT_F_USED_MASK,DEFIO_PORT_G_USED_MASK,DEFIO_PORT_H_USED_MASK,DEFIO_PORT_I_USED_MASK,DEFIO_PORT_J_USED_MASK
# define DEFIO_PORT_OFFSET_LIST DEFIO_PORT_A_OFFSET,DEFIO_PORT_B_OFFSET,DEFIO_PORT_C_OFFSET,DEFIO_PORT_D_OFFSET,DEFIO_PORT_E_OFFSET,DEFIO_PORT_F_OFFSET,DEFIO_PORT_G_OFFSET,DEFIO_PORT_H_OFFSET,DEFIO_PORT_I_OFFSET,DEFIO_PORT_J_OFFSET
#endif
