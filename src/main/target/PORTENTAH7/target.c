...
//    DEF_TIM(TIM2,  CH1, PA15, TIM_USE_PWM,                 0,  0,  0 ),
    ...
    DEF_TIM(TIM1,  CH1, PK1,  TIM_USE_MOTOR,                0, 0,  4),
    DEF_TIM(TIM1,  CH2, PJ11, TIM_USE_MOTOR,                0, 1,  4),
    DEF_TIM(TIM8,  CH1, PC6,  TIM_USE_MOTOR,                0, 2,  4),
    DEF_TIM(TIM8,  CH2, PC7,  TIM_USE_MOTOR,                0, 3,  4),
